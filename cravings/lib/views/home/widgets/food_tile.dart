        ...
        children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      ReusableText(text: food['title'], style: appStyle(11, kDark, FontWeight.w400)),

                      ReusableText(text: "Delivery Time: ${food['time']}", style: appStyle(11, kGray, FontWeight.w400)),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Center(child: ReusableText(text: "Rs ${food['price'].toStringAsFixed(2)}", style: appStyle(12, kLightWhite, FontWeight.bold)),),
            ),
          ),
